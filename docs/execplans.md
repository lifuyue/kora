...
- **当前集成状态**：`main` 已包含 M0-M4 与大部分基础设施，M5 主要实现在 `feat/m5` 分支上，尚需继续整理与验证

现在需要：在既有工程基础上继续收尾 M5、补齐设置遗留、回写文档状态，并按修正后的优先级推进 M6。
...
- `M1` 工程脚手架：已完成
- `M2` 核心基础设施：已完成
- `M3` 设置与引导：主体完成，仍有设置页补齐项
- `M4` 聊天 MVP：主体完成，仍有少量体验打磨项
- `M5` 知识库：功能主线已实现，待持续整理验证
- `M6` 高级功能：未开始
